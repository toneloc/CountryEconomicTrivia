...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mTxtBestStreak;
    private TextView mTxtCurrentStreak;
    ...
    private View.OnClickListener mClickListener4;

    private Intent mIntentToGoToInfoPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCountries[30] = new Country("Venezuela","VEN",381286000000D,30410000,88781);
        mCountries[31] = new Country("Colombia","COL",377740000000D,47791393,7904);
        mCountries[32] = new Country("South Africa","ZAF",350141000000D,53000000,6606);
        ...
        mCountries[40] = new Country("Finland","FIN",272217000000D,5461512,49843);
        ...
        mCountries[53] = new Country("Romania","ROM",199044000000D,20121641,9892);
        mCountries[54] = new Country("Vietnam","VNM",186205000000D,89710000,43357);
        ...
        mCountries[70] = new Country("Luxembourg","LUX",64874000000D,556319,116613);
        mCountries[71] = new Country("Myanmar","MMR",64330000000D,53437159,1204);
        mCountries[72] = new Country("Dominican Republic","DOM",64138000000D,10405943,6164);
        mCountries[73] = new Country("Uzbekistan","UZB",62644000000D,30251000,2071);
        ...
        mCountries[76] = new Country("Uruguay","URY",57471000000D,3407000,16869);
        ...
        mCountries[94] = new Country("Coute dIvoire","CIV",34254000000D,22157107,1546);
        mCountries[95] = new Country("Bahrain","BHR",33851000000D,1361930,24855);
        mCountries[96] = new Country("Congo","ZAR",33121000000D,74877030,442);
        mCountries[97] = new Country("Bolivia","BOL",32996000000D,10561887,3124);
        mCountries[98] = new Country("Cameroon","CMR",32051000000D,22773014,1407);
        ...
        mCountries[106] = new Country("Afghanistan","AFG",20038000000D,31550000,656);
        ...
        mCountries[112] = new Country("Iceland","ISL",17036000000D,327386,52036);
        mCountries[113] = new Country("New Guinea","PNG",16929000000D,7463577,2268);
        mCountries[114] = new Country("Cambodia","KHM",16778000000D,15328136,1095);
        mCountries[115] = new Country("Georgia","GEO",16530000000D,3727000,4435);
        ...
        mCountries[119] = new Country("Equitorial Guinea","GNQ",15530000000D,820885,18919);
        ...
        mCountries[138] = new Country("Bahamas","BHS",8511000000D,383054,22219);
        mCountries[139] = new Country("Niger","NER",8169000000D,19113728,427);
        ...
        mTxtBestStreak = (TextView) findViewById(R.id.txt_best_streak);
        mTxtCurrentStreak = (TextView) findViewById(R.id.txt_current_streak);
        ...
        mInfoButton = (TextView) findViewById(R.id.txt_info_button);  //info button
        ...
        //3 the submitAnswer method called above also calls the setQuestion and setCountries method, then updateStreak method

        mIntentToGoToInfoPage = new Intent(MainActivity.this, InfoActivity.class);

        //set info button click listener
        mClickListener4 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(mIntentToGoToInfoPage);
            }
        };

        mInfoButton.setOnClickListener(mClickListener4);
    ...
    private boolean submitAnswer(Country a) {
        ...
        switch (questionType) {
            ...
            case 0:
                ...
                String info1 = country1.getmName() + " GDP: $" + formatter.format(country1.getmGDP());
                mInfo1.setText(info1);
                String info2 = country2.getmName() + " GDP: $" + formatter.format(country2.getmGDP());
                mInfo2.setText(info2);
                String info3 = country3.getmName() + " GDP: $ " + formatter.format(country3.getmGDP());
            ...
            case 1:
                ...
                String info4 = country1.getmName() + " Population: " + formatter.format(country1.getmPop());
                mInfo1.setText(info4);
                String info5 = country2.getmName() + " Population: " + formatter.format(country2.getmPop());
                mInfo2.setText(info5);
                String info6 = country3.getmName() + " Population: " + formatter.format(country3.getmPop());
            ...
            case 2:
                ...
                String info7 = country1.getmName() + " GDP/Capita: $" + formatter.format(country1.getmGDPPerCapita());
                mInfo1.setText(info7);
                String info8 = country2.getmName() + " GDP/Capita: $" + formatter.format(country2.getmGDPPerCapita());
                mInfo2.setText(info8);
                String info9 = country3.getmName() + " GDP/Capita: $" + formatter.format(country3.getmGDPPerCapita());
        ...
        //update streak
        updateStreak(gotCorrectAnswer);
        return gotCorrectAnswer;
    }

    private void updateStreak(boolean gotCorrectAnswer) {
        ...
        if (gotCorrectAnswer) {
            ...
            if (streak > bestStreak) {
                bestStreak = streak;
                mToast.makeText(getApplicationContext(), "New best streak!", Toast.LENGTH_SHORT).show();
            }
            else {
        ...
        mTxtBestStreak.setText("Best streak: " + Integer.toString(bestStreak));
        mTxtCurrentStreak.setText("Current streak: " + Integer.toString(streak));
